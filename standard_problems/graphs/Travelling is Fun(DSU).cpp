/*There are cities numbered from to . Two cities, and , are connected by a
bidirectional road if and only if , where is the greatest common divisor of and
. Julia is planning a long vacation and wants to know whether a path exists from
city to city
...
integers where the value at each index (where ) is if a path exists from city to
city ; otherwise, it's
...
is provided for you. The below is documentation in case you need to create
custom testcases.
