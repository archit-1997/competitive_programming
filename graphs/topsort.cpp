...
//Topological Sorting : prints the topsort order in the lexicographically smallest order
...
int main()
{
	...
	//sort the adjaceny list in descending order to ensure that the answer that you get
